  ...
  return (
    <div className="repayment-card">
      <div className="repayment-info">
        <div className="repayment-icon-container">
          <svg
        ...
        <div className="repayment-details">
          <h4 className="repayment-title">Loan Repayment</h4>
          <p className="repayment-date">
      ...
      <div className="repayment-amount">
        <h4 className="repayment-amount-value">
